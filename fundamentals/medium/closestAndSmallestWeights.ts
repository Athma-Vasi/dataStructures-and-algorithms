...
function closestAndSmallestWeights(str: string) {
	...
	const sortedWeightsAndIdxs = Object.entries(Object.fromEntries(weightsMap)).sort(
...
console.log(
	closestAndSmallestWeights('456899 50 11992 176 272293 163 389128 96 290193 85 52')
) //[[13, 9, 85], [14, 3, 176]]

console.log(
	closestAndSmallestWeights('239382 162 254765 182 485944 134 468751 62 49780 108 54')
)
//[[8, 5, 134], [8, 7, 62]]

console.log(
	closestAndSmallestWeights('241259 154 155206 194 180502 147 300751 200 406683 37 57')
)
//[[10, 1, 154], [10, 9, 37]]

console.log(
	closestAndSmallestWeights('89998 187 126159 175 338292 89 39962 145 394230 167 1')
)
//[[13, 3, 175], [14, 9, 167]]
